...
cov_f_lst = ['age', 'sex', 'race', 'educ', 'tdi', 'smk', 'alc', 'bmi', 'fastingtime']
my_formula = "age + C(sex) + C(race) + educ + tdi + C(smk) + C(alc) + bmi + fastingtime + x_omics"
...
myout_df.to_csv(dpath + 'Results/Association/'+omics+'_Step'+str(step)+'.csv', index=False)
